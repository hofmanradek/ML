...
where r.sta='LPAZ' and r.iphase in  ('Sn', 'Lg', 'Rg') and ass.phase in  ('Sn', 'Lg', 'Rg') and abs(r.time - larr.time) <= 4
order by r.time; --174
...
(select htov from idcx.amp3c@extadb where  arid=r.arid and cfreq=4) as htov5
from idcx.arrival@extadb r join idcx.apma@extadb ap on r.arid=ap.arid join leb.assoc@extadb ass on ass.arid=r.arid join leb.arrival@extadb larr on larr.arid=r.arid
where r.sta='LPAZ' and r.iphase not in  ('Sn', 'Lg', 'Rg') and ass.phase in  ('Sn', 'Lg', 'Rg') and abs(r.time - larr.time) <= 4
order by r.time; --465
...
(select htov from idcx.amp3c@extadb where  arid=r.arid and cfreq=4) as htov5
from idcx.arrival@extadb r join idcx.apma@extadb ap on r.arid=ap.arid join leb.assoc@extadb ass on ass.arid=r.arid join leb.arrival@extadb larr on larr.arid=r.arid
where r.sta='LPAZ' and r.iphase in ('Pn', 'Pg') and ass.phase in ('Pn', 'Pg') and abs(r.time - larr.time) <= 4
...
(select htov from idcx.amp3c@extadb where  arid=r.arid and cfreq=4) as htov5
from idcx.arrival@extadb r join idcx.apma@extadb ap on r.arid=ap.arid join leb.assoc@extadb ass on ass.arid=r.arid join leb.arrival@extadb larr on larr.arid=r.arid
where r.sta='LPAZ' and r.iphase not in ('Pn', 'Pg') and ass.phase in ('Pn', 'Pg') and abs(r.time - larr.time) <= 4
...
from idcx.arrival@extadb r join idcx.apma@extadb ap on r.arid=ap.arid join leb.assoc@extadb ass on ass.arid=r.arid join leb.arrival@extadb larr on larr.arid=r.arid
where r.sta='LPAZ' 
and r.iphase in ('P', 'PKP', 'PKPbc', 'PcP', 'PKPab', 'pP', 'PP', 'PKKPbc', 'ScP', 'SKPbc', 'PKhKP', 'PKiKP', 'PKP2', 'Pdiff', 'SKP', 'pPKP', 'PKKPab', 'pPKPbc', 'PKKP', 'SKKPbc', 'PKP2bc', 'P3KPbc', 'sP', 'SKPab', 'P4KPbc', 'PKP2ab', 'pPKPab', 'P3KP', 'SKKP', 'SKiKP', 'SKKPab', 'SKKS', 'P4KP', 'SP', 'S', 'ScS', 'SS', 'Sdiff', 'pPcP', 'sPKP') 
...
from idcx.arrival@extadb r join idcx.apma@extadb ap on r.arid=ap.arid join leb.assoc@extadb ass on ass.arid=r.arid join leb.arrival@extadb larr on larr.arid=r.arid
where r.sta='LPAZ' 
and r.iphase not in ('P', 'PKP', 'PKPbc', 'PcP', 'PKPab', 'pP', 'PP', 'PKKPbc', 'ScP', 'SKPbc', 'PKhKP', 'PKiKP', 'PKP2', 'Pdiff', 'SKP', 'pPKP', 'PKKPab', 'pPKPbc', 'PKKP', 'SKKPbc', 'PKP2bc', 'P3KPbc', 'sP', 'SKPab', 'P4KPbc', 'PKP2ab', 'pPKPab', 'P3KP', 'SKKP', 'SKiKP', 'SKKPab', 'SKKS', 'P4KP', 'SP', 'S', 'ScS', 'SS', 'Sdiff', 'pPcP', 'sPKP')
and ass.phase in ('P', 'PKP', 'PKPbc', 'PcP', 'PKPab', 'pP', 'PP', 'PKKPbc', 'ScP', 'SKPbc', 'PKhKP', 'PKiKP', 'PKP2', 'Pdiff', 'SKP', 'pPKP', 'PKKPab', 'pPKPbc', 'PKKP', 'SKKPbc', 'PKP2bc', 'P3KPbc', 'sP', 'SKPab', 'P4KPbc', 'PKP2ab', 'pPKPab', 'P3KP', 'SKKP', 'SKiKP', 'SKKPab', 'SKKS', 'P4KP', 'SP', 'S', 'ScS', 'SS', 'Sdiff', 'pPcP', 'sPKP')
and abs(r.time - larr.time) <= 4
