...
select count(*) from idcx.arrival@extodb where sta='URZ' and lddate >= to_date('2018/12/13','yy/mm/dd'); --2460 as of 9.1.2019
...
select count(*) from URZ_EVAL_OPS; --2460
...
select count(*) from URZ_EVAL_OPS where assoc_phase is not null; -- 127 associated
 
select count(*) from URZ_EVAL_OPS where class_iphase_dev='regS' and CLASS_PHASE_ODB='regS' and assoc_phase is not null; -- 17
select count(*) from URZ_EVAL_OPS where class_iphase_odb='regS' and CLASS_PHASE_ODB='regS' and assoc_phase is not null; -- 17

select count(*) from URZ_EVAL_OPS where class_iphase_dev='regP' and CLASS_PHASE_ODB='regP' and assoc_phase is not null; -- 17
select count(*) from URZ_EVAL_OPS where class_iphase_odb='regP' and CLASS_PHASE_ODB='regP' and assoc_phase is not null; -- 17

select count(*) from URZ_EVAL_OPS where class_iphase_dev='T' and CLASS_PHASE_ODB='T' and assoc_phase is not null; -- 45
select count(*) from URZ_EVAL_OPS where class_iphase_odb='T' and CLASS_PHASE_ODB='T' and assoc_phase is not null; -- 45

select count(*) from URZ_EVAL_OPS where class_iphase_dev = class_phase_odb; --1339/2460 correct => 0.544
select count(*) from URZ_EVAL_OPS where class_iphase_odb = class_phase_odb; --1339/2460 correct => 0.544

select count(*) from URZ_EVAL_OPS where class_iphase_dev = class_phase_odb and assoc_phase is not null; --79/127 cor => 0.622
select count(*) from URZ_EVAL_OPS where class_iphase_odb = class_phase_odb and assoc_phase is not null; --79/127 cor => 0.622

select count(*) from URZ_EVAL_OPS;

-- N phase rate
select count(*) from URZ_EVAL_OPS where class_iphase_dev='N' and assoc_phase is not null; --5 / 127 0.039
select count(*) from URZ_EVAL_OPS where class_iphase_odb='N' and assoc_phase is not null; --5 / 127 0.039
